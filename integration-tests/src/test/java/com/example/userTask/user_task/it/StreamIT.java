package com.example.userTask.user_task.it;
...
import com.example.userTask.user_task.stream.api.StreamService;
import com.example.userTask.user_task.hello.api.GreetingMessage;
import com.example.userTask.user_task.hello.api.HelloService;
